...
class ProbeTone(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Prueba Tono", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Prueba Tono")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ProbeTone")
        ...
        self._tx_gain_range = Range(0, 50, 1, 20, 200)
        ...
        self._rx_gain_range = Range(0, 50, 1, 20, 200)
        ...
        self._freq_range = Range(5e9, 6e9, 50e6, 5.5e9, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, 1e6, (900e-3), 0, 0)
...
def main(top_block_cls=ProbeTone, options=None):
