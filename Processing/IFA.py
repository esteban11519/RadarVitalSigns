...
class IFA(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_0_1 = analog.sig_source_c(samp_rate, analog.GR_CONST_WAVE, f_h, A_h, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0_1, 0), (self.blocks_add_xx_0, 2))
    ...
    def set_f_h(self, f_h):
        ...
        self.analog_sig_source_x_0_0_1.set_frequency(self.f_h)
    ...
    def set_A_h(self, A_h):
        ...
        self.analog_sig_source_x_0_0_1.set_amplitude(self.A_h)
